...
module.exports = { DECOR, slides: [
  ...
  /* ================= 01 · HOOK ================= */
  {
    main: `
      <div class="head"></div>
      <h1 class="title title--hero">Suis le voyage<br>d'un <span class="blue">EURO</span>.</h1>
      <span class="float" style="top:312px;right:104px">100€ &rarr; ?</span>
      <p class="body muted" style="margin-top:44px;max-width:820px;font-size:34px">
        De la carte bleue de ton client jusqu'à ta poche.
        Il n'arrive pas entier.
      </p>
      <div class="coin bleed"><span>€</span></div>
